...
are decoded into the handler's parameter type. Results are returned as raw
text, raw bytes, or JSON. Registration rejects types JSON cannot represent,
such as channels. Dynamic JSON fields use
